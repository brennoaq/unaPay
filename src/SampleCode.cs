    ...
    public class SampleCode
    {
        ...
        public static void RunSample(string cmdLineArg = null)
        {
            try
            {
                ...
                if (_sampleToRun == "1") _sampleToRun = "ProcessPayment";
                if (_sampleToRun == "2") _sampleToRun = "TokenizeCard";
                ...
                if (className == null)
                {
                    logger.Warn("Opção não encontrada:: {0}", _sampleToRun);
                    Console.WriteLine("Opção não encontrada: {0}", _sampleToRun);
        ...
        private static void ShowMethods()
        {
            ...
            Console.Write("1 - Realizar Pagamento no Cartão  ");
            Console.WriteLine("\n");
            Console.Write("2 - Realizar Adicionar um Cartão  ");
            Console.WriteLine("\n");
            Console.Write("Digite um numero de acordo com a opção Escolhida: ");
