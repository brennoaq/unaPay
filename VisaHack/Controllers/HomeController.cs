...
namespace VisaHack.Controllers
{
    public class HomeController : Controller
    {
        private static readonly string PathOfSamplesFolder = "D:\\visa hack\\cybersource-rest-samples-csharp-master\\cybersource-rest-samples-csharp-master\\src\\\\Samples";
        ...
        public ActionResult Index()
        {
            ...
            Type className = Type.GetType("D:\\visa hack\\cybersource - rest - samples - csharp - master\\cybersource - rest - samples - csharp - master\\src\\Samples.Payments.CoreServices.ProcessPayment");
            RunSample("{Name = \"ProcessPayment\" FullName = \"Cybersource_rest_samples_dotnet.Samples.Payments.CoreServices.ProcessPayment\"}", "ProcessPayment");
            return View();
        }
        ...
        public static void RunSample(string claseNome = null, string cmdLineArg = "")
        {
            try
            {
                _sampleToRun = cmdLineArg;
                ...
                {
                    className = Type.GetType("Cybersource_rest_samples_dotnet.Samples.Payments.CoreServices.ProcessPayment" + _sampleToRun);
        ...
        private static void InitializeApiList()
        {
            ...
            var dirList = Directory.GetDirectories("D:\\visa hack\\cybersource-rest-samples-csharp-master\\cybersource-rest-samples-csharp-master\\src\\\\Samples", "*");
            var apiFamilies = new List<string>();
